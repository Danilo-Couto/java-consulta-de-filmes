...
public class Queries7Test {

  @Test
  @DisplayName("Consulta 7 - consulta com base em coleção vazia deve retornar um Map vazio")
  ...
  @Test
  @DisplayName("Consulta 7 - consulta deve retornar resultados corretos")
  ...
  @Test
  @DisplayName(
      "Consulta 7 - filme que atende os requisitos e pertence a mais de uma categoria deve aparecer"
          + " em todas elas"
  )
