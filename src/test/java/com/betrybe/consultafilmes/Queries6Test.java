...
public class Queries6Test {

  @Test
  @DisplayName("Consulta 6 - consulta com base em coleção vazia deve retornar uma lista vazia")
  ...
  @Test
  @DisplayName("Consulta 6 - consulta deve retornar resultados corretos na ordem correta")
  ...
  @Test
  @DisplayName("Consulta 6 - nenhum filme deve aparecer mais de uma vez na lista de resultados")
