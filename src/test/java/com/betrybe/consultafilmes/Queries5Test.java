...
public class Queries5Test {

  @Test
  @DisplayName("Consulta 5 - consulta com base em coleção vazia deve retornar uma lista vazia")
  ...
  @Test
  @DisplayName("Consulta 5 - consulta deve retornar resultados corretos na ordem correta")
  ...
  @Test
  @DisplayName("Consulta 5 - nenhum artista deve aparecer mais de uma vez na lista de resultados")
